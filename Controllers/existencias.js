...
const existenciasControllers = {
    ...
    listarTodo: async (req,res) => {
        try {
            const {idEmpresa, pagina, textoFiltro, BolsaEstado, idBodega} = req.body;
            ...
            const cantExistencias = await Existencias.contarTodoFiltro({pEmpId:idEmpresa, pBodegaId:vBodegaId, pBolsaEstado:vBolsaEstado, pTexto:vTextoFiltro});
            ...
            const existencias = await Existencias.traerTodo({pEmpId:idEmpresa, pBodegaId:vBodegaId, pBolsaEstado:vBolsaEstado, pOffset:vOffset, pTexto:vTextoFiltro});
